                                            ...
                                            <Item>
                                                <div className="flex">
                                                    <div className="flex-col justify-start items-start flex">
                                                        {
                                                        <Link to={`/detail/${item.id}`} state={{item : item, startDate : startDate, endDate : endDate}}><img className="object-cover w-[260px] h-[200px]" src={item.imagePath[0]} alt="camping item img"/></Link>}
